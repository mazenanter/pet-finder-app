...
part 'breed_model_reponse.g.dart';
...
class BreedModelResponse {
  ...
  factory BreedModelResponse.fromJson(Map<String, dynamic> json) =>
      _$BreedModelResponseFromJson(json);
  Map<String, dynamic> toJson() => _$BreedModelResponseToJson(this);
}
