...
import 'package:pet_finder_app/features/favourite/data/models/weight_details_model.dart';

part 'breed_info_model.g.dart';

@JsonSerializable()
class BreedInfoModel {
  final WeightDetailsModel weight;
  final String id;
  final String name;
